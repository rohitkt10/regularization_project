...
Subtask 1.4 - Dropout regularization, batch norm and l2 kernel regularization.
...
This subtask establishes a baseline for the effect of training the deep and shallow models
without any `tricks` for regularization or improving training dynamics.
...
def main():
    ...
    RESULTSDIR = os.path.join(BASERESULTSDIR, 'task_1_sub_3', f"dropout={args.dropout1}")
