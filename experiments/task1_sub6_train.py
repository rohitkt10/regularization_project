...
Subtask 1.6 - Dropout + l2 ; no batch norm
...
def main():
    ...
    assert args.l2 > 0., 'This experiment requires a nonzero l2 reg.'
    ...
    RESULTSDIR = os.path.join(BASERESULTSDIR, 'task_1_sub_6',"l2="+format(args.l2, ".0e"),
                            f"dropout={args.dropout1}")
