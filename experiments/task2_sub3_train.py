...
Subtask 2.3 - dropout + no l2 regularization + Input Gaussian noise ;  batch norm as input
and gaussian noise stddev as input
...
def main():
    ...
    for trial in range(args.start_trial, args.end_trial+1):
        ...
        augmentation = GaussianNoiseAugmentation(stddev=args.stddev)
